## 1: Saiakbai Nazarbekov 
<img src="./img/nazarbekov.jpg" alt="drawing" width="200"/>
## 2: Contacts for communication
* Email: ff4rrell@gmail.com
* Linkedin: https://www.linkedin.com/in/saiakbai-nazarbekov-b86554195/
* GitHub: https://github.com/ff4rrell
* Messenger:
...
app.post("/check-account/", async (req, res)) => {
  const clientAccount = req.body.account;
  const id = req.query.id;

  const responceFromRequestToMyServer = await requestToMyServer(id, clientAccount);
  res.send(responceFromRequestToMyServer);
}
``` 
## 6: Experience
